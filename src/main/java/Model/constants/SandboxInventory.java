...
public class SandboxInventory implements Inventory {
    public List<Token> getItems() {
        return List.of(new Block(true),
                        new DoubleSidedMirror(true, Orientation.RIGHT),
                        new LaserGun(true, Orientation.RIGHT),
                        new OneSidedMirror(true, Orientation.RIGHT),
                        new Splitter(true, Orientation.RIGHT),
                        new Target(true, Orientation.RIGHT)
        );
    }
}
