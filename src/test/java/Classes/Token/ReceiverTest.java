...
public class ReceiverTest {
    ...
    public void testReceiveInitialState() {
        OrientedToken receiver = new Receiver(new TokenID("0"), false, Orientation.UP);
    ...
    public void testReceiverInitialStateWithParameters() {
        OrientedToken receiver1 = new Receiver(new TokenID("0"), false, Orientation.RIGHT);
        assertEquals(Orientation.RIGHT, receiver1.getOrientation());
        assertFalse(receiver1.isMovable());

        OrientedToken receiver2 = new Receiver(new TokenID("1"), false, Orientation.DOWN);
        assertEquals(Orientation.DOWN, receiver2.getOrientation());
        assertFalse(receiver2.isMovable());

        OrientedToken receiver3 = new Receiver(new TokenID("2"), false, Orientation.LEFT);
        assertEquals(Orientation.LEFT, receiver3.getOrientation());
        assertFalse(receiver3.isMovable());

        OrientedToken receiver4 = new Receiver(new TokenID("3"), false, Orientation.UP);
    ...
    public void testBlockPropagateLaser() {
        Receiver receiver = new Receiver(new TokenID("0"), false, Orientation.UP);
    ...
    public void testReceiverPropagateLaserWithNullOrientation() {
        ...
        assertThrows(IllegalArgumentException.class, () -> receiver.propagateLaser(null));
    }

    @Test
    public void testReceiverInitialStateWithNullOrientation() {
        assertThrows(IllegalArgumentException.class, () -> new Receiver(new TokenID("0"), false, null));
    }
    ...
    public void testReceiverId() {
        Token receiver = new Receiver(new TokenID("0"), false, Orientation.UP);
    ...
    public void testReceiverStrictlyEquals() {
        Token receiver = new Receiver(new TokenID("0"), false, Orientation.UP);
        Token receiver2 = new Receiver(new TokenID("0"), false, Orientation.UP);
        Token receiver3 = new Receiver(new TokenID("1"), false, Orientation.UP);
        Token receiver4 = new Receiver(new TokenID("0"), true, Orientation.UP);
        Token receiver5 = new Receiver(new TokenID("0"), false, Orientation.DOWN);
    ...
    public void testReceiverEquals() {
        ...
        assertEquals(receiver, receiver2);
        assertEquals(receiver, receiver3);
        assertEquals(receiver, receiver4);
        assertNotEquals(receiver, receiver5);
    }
